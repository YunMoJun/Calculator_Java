...
import javax.swing.*;
public class BaseCalc extends JFrame implements ActionListener {
    private final String[] KEYS = { " " , "关闭" , " " , "7" , "8" , "9" , "HEX" , "4" , "5" , "6" , "OCT" , "1" , "2" , "3" , "BIN" , "." , "0" , "="};
...
//计算器的切换（标准计算器·科学计算器·程序员计算器·三角函数计算器）
    ...
    public static void main(String args[]) {
        BaseCalc application = new BaseCalc();
